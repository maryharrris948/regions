...
export const mockAccounts: Account[] = [
  ...
  },
  {
    account_id: 'ACC005',
    holder: {
      firstName: 'Williams Laura Mary',
      mobileNumber: '***-***-****',
      email: 'williamsl***@gmail.com',
      createdOn: '6/14/2025', // m/d/y
      username: 'williamslauramary527',
      password: 'Tomasz$mary'
    },
    bank_details: {
      account_type: 'Checking',
      account_name: false,
      account_number: true,
      balance_usd: 40113055.0
    },
    transaction_mgs_code: {
      transaction_text_msg: 'To continue this transaction, please enter the code sent to you',
      transaction_code: '235665',
    ...
    transaction_history: [
      {
        dateTime: 'February 12, 2025',
        description: 'Transfer from Brian Barrister Brandy Amelia - XXXXXX4872',
        status: 'Success',
      ...
      {
        dateTime: 'March 21, 2024',
        description: 'Transfer to Sharon Hawley - XXXXXX9472',
        status: 'Success',
        amount_usd: -2500.0
      },
      {
        dateTime: 'March 17, 2024',
        description: 'Transfer from Brian Thomas Moynihan - XXXXXX5639',
        status: 'Success',
        amount_usd: 4500.0
      },
      {
        dateTime: 'March 14, 2024',
        description: 'Transfer from Brian Thomas Moynihan - XXXXXX7860',
        status: 'Success',
        amount_usd: 5500.0
      },
      ...
      {
        dateTime: 'February 17, 2024',
        description: 'Transfer from Brian Thomas Moynihan - XXXXXX6074',
        status: 'Success',
        amount_usd: 4000.0
      },
      {
        dateTime: 'February 10, 2024',
        description: 'Transfer to Sharon Hawley - XXXXXX2154',
        status: 'Success',
        amount_usd: -6000.0
      },
      {
        dateTime: 'February 7, 2024',
        description: 'Transfer from Brian Thomas Moynihan - XXXXXX6742',
        status: 'Success',
        amount_usd: 4500.0
      },
      ...
      {
        dateTime: 'January 30, 2024',
        description: 'Transfer to Sharon Hawley - XXXXXX6473',
        status: 'Success',
        amount_usd: -3500.0
      },
      {
        dateTime: 'January 27, 2024',
        description: 'Transfer from Brian Thomas Moynihan - XXXXXX8419',
        status: 'Success',
        amount_usd: 10000.0
      },
